...
Si suponemos que la ganancia del vendedor va a ser del 30% de cada ordenador, 
y que el impuesto aplicable es del 21%, diseñar un programa que calcule el precio final del portátil y 
lo muestre por pantalla. El precio del coste de fabricación se debe obtener leyéndolo desde el teclado.
...
public class ejercicio1 {
    public static void main(String[] args) {
        ...
        String tipoPrecio =(precioFinal <= 600) ? " Normsl" : "De lijo";
        System.out.println("El poetatil tiene un precio " + tipoPrecio);
        sc.close();
    }
}
